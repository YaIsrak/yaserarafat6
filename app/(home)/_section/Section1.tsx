		...
		<section className='section'>
			<div className='container'>
				...
				<RevealList
					...
					<div className='flex justify-center items-center gap-8'>
						...
						<div className='text-base hidden md:block max-w-[20em] mt-10 text-muted-foreground font4'>
							Hi! I’m{' '}
							<span className='text-primary'>MD Yaser Arafat Israk</span>, Web
							developer and Illustrator from Bangladesh, located in Chattogram
						</div>
					</div>
					<p>Israk</p>
				...
				<RevealList
					...
					<h1 className='mt-2 font-light text-sm md:text-4xl text-muted-foreground'>
						Web developer
					</h1>
					<h1>&</h1>
					<h1 className='mt-2 font-light text-sm  md:text-4xl text-muted-foreground'>
