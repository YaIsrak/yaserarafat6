...
export default function GraceAndBeauty() {
	return (
				...
				<div className='grid grid-cols-1 gap-5 md:grid-cols-2'>
					<div className='my-auto text-left md:text-right'>
						<div className='space-y-2'>
							...
							<p>
								A vision of grace and beauty, a woman in a traditional
								Indian sari stands before us. Her long, flowing hair
								cascades over her shoulders, and her serene eyes meet
								ours. The sari she wears is a masterpiece of color and
								pattern, its vibrant hues echoing the vibrant colors of
								India itself
							</p>
						</div>
					</div>
