...
import TransparentPP from '@/public/transparent_pp.png';
				...
				<div className='grid md:grid-cols-2 grid-cols-1 items-center min-h-screen'>
					<div className='flex justify-center h-[50vh] md:h-full'>
						<div className='relative w-full h-full'>
							<Image
								...
								className='grayscale h-full w-full object-contain'
								fill
							/>
						</div>
					</div>
					...
					<div className='max-w-xl space-y-4'>
						...
						<p className='text-sm font-semibold'>
							...
							discipline, and a constant pursuit of growth.
							<br /> <br />
							Beyond work, I appreciate the simple joys of life—good
							conversations, meaningful experiences, and the endless
							possibilities that technology and art bring.
						</p>
