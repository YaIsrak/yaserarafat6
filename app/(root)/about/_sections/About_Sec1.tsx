				...
				<BlurFade
					...
					<div className='flex-1 space-y-4'>
						...
						<p className='text-xs tracking-widest text-muted-foreground md:text-sm'>
							{/* todo: update bio */}
							{/*  */}A BANGLADESH BASED ARTIST, WEB DEVELOPER &
							ILLUSTRATOR SPECIALIZING IN BRANDING AND ILLUSTRATION. I
							LOVE CREATING BOLD CREATIVE WORKS AND ENJOY ILLUSTRATING
							COLORFUL EDITORIAL VISUALS AND DRAWINGS WHICH ARE FUN TO
