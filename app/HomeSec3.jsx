		...
		<section className='container'>
			...
			>
				...
				<div className='tw-mt-6 md:tw-my-auto'>
					<p>
						The use of bold colors and simple shapes is characteristic of Roy's style.
						The black of Kohotobyo's hair and dress contrasts sharply with the light
						brown of her skin and the white of the background. The artist has used
						simple lines to create a sense of depth and perspective in the portrait,
						and the use of light and shadow high- lights Kohotobyo's features
					</p>
				</div>
			</RevealList>
		</section>
