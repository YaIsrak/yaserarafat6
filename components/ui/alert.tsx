  ...
  "relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-rose-500/50 text-rose-500 dark:border-rose-500 [&>svg]:text-rose-500 dark:border-rose-900/50 dark:text-rose-900 dark:dark:border-rose-900 dark:[&>svg]:text-rose-900",
      },
    },
    defaultVariants: {
      variant: "default",
