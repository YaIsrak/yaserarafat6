...
export default function Navbar() {
	...
	return (
		<nav
			className={cn(
				'fixed top-0 left-0 w-full border-muted-foreground/20 backdrop-blur-sm text-white md:text-white transition ease-[cubic-bezier(1,0,0,1)] duration-500 md:bg-transparent md:backdrop-blur-none z-50 mix-blend-exclusion',
